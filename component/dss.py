...
if __name__ == '__main__':
    net = DSS(d_model=192, d_state=192, bidirectional=False, transposed=False)
    in_data = torch.randn(3, 1000, 192)
    out, _ = net(in_data)
    print('finish')
    import thop
    total_ops, total_params = thop.profile(net, (in_data, ))
    flops, params = thop.clever_format([total_ops, total_params], "%.3f")
    print(flops, params)