...
TRAINING_KEY_WORDS = [
                            ...
                            ('/mnt/raid2/user_space/yanyongjie/asr/实采语音/你好小捷/', 50),
                            ('/mnt/raid2/user_space/yanyongjie/asr/实采语音/小捷你好/', 50),
                            ('./你好小婕', 20), 
                            ('./小婕你好', 20),
                            # ('./oneshot', 1),
...
TRAINING_RIR = {
       'L1': {'rir': ['/home/yanyongjie/train_data/car_zone/rir/jietu/L1'],
              'channel': 0},
       'R1': {'rir': ['/home/yanyongjie/train_data/car_zone/rir/jietu/R1'],
              'channel': 1},
}
TRAINING_CHECK_PATH = './check'

ROAD_SNR_LIST = [1, 2, 5, 10]
POINT_SNR_LIST = [5, 10]
